...
import cv2
from PyQt6.QtWidgets import QApplication, QWidget, QLabel, QVBoxLayout, QHBoxLayout, QFrame, QCheckBox
...
class CameraWindow(QWidget):
    def __init__(self):
        ...
        print("Initializing Identity Manager for face detection...")
        ...
        self.bbox_toggle.setChecked(True)
